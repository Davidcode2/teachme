  ...
  <div class="${properties.kcLoginContainer!}">
    ...
    <main class="${properties.kcLoginMain!}">
      <div class="${properties.kcLoginMainHeader!}">
        <div class="schreinerei-brand">
          <div class="schreinerei-brand__logo" aria-hidden="true"></div>
          <div class="schreinerei-brand__title">Schreinerei</div>
          <div class="schreinerei-brand__subtitle">Baustellenverwaltung</div>
        </div>

        <div class="schreinerei-page-header">
          <div class="schreinerei-page-title">
