    ...
    <div className="flex h-full w-full justify-center">
      <div className="searchBox lg:w-[800px] sm:w-[600px] w-4/5 self-center">
        <div className="z-50 searchBox border border-fuchsia-200 bg-white shadow-2xl shadow-fuchsia-900 rounded-lg p-10 blur-none flex flex-col">
          <div className="flex">
            <input value={searchString} onChange={changeSearchString} autoFocus={true} className="flex-grow border border-fuchsia-200 searchBox p-4 rounded-full focus:outline-none focus:outline-purple-300 focus:shadow-lg focus:shadow-purple-200 focus:border-none" type="text" />
